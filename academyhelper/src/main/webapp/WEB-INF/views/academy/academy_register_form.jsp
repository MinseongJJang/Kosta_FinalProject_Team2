			...
			<table class="table">
				   ...
				   <tbody>
						<tr>
				      			...
				      			<span id="mainPic"></span>
					   			<script>
								    $(document).ready(function() {
								        ...
								        var curtime1 = "";
								    	var img = "";
								        $('#amenitiesPicUpload').change(function() {
								        	var formData = new FormData();
								        	$.each($("#amenitiesPicUpload")[0].files, function(i, file) {
												formData.append("file", file);
											});
								        	$.ajax({
									              data: formData,
									              ...
									              success: function(url) {
													...
													img += "<img src="+path+" width=200 height=200/>"; 
									            	$("#curtime1").html(curtime1);
									            	if(img!=""){
									            		$("#amenitiesPic").html(img);
									            	}
									              }
									          });//ajax
								        });//change
						 ...
						 <tr>
							<td colspan="3"><input type="file" id="acaMainPic" name="file"></td><!--  -->
				   		</tr>
						 <tr style="height: 250px;">
					        <th >학원 시설 사진</th>
							<td colspan="2">
								<span id="amenitiesPic"></span>
							</td>
				      	</tr>
				      	<tr>
				      		<td colspan="2"><input type="file" id="amenitiesPicUpload" name="file"></td>
				      	</tr>
				   </tbody>
				   <tfoot>
				  		<tr>
