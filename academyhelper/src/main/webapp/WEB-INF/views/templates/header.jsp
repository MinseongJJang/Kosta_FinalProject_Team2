			...
			<div class="col-md-12">
				...
				<nav id="primary-nav" class="dropdown cf">
					<ul class="dropdown menu">
						...
						<li><a href="#"><img src="${pageContext.request.contextPath}/resources/img/login.png" style="width:20px; height:20px;"></a></li>	
						<li></li>
						<li><a href="#menu-toggle" class="btn btn-secondary" id="menu-toggle"><img src="${pageContext.request.contextPath}/resources/img/chatting_off.png" style="width:20px; height:20px" name="img" id="imgChange"></a></li>
					</ul>
				</nav>
				<!-- / #primary-nav -->
			</div>
