				   ...
				   <tbody>
						<tr >
				      	...
				      	<tr>
							...
							<td><textarea cols="90" rows="130" id="sugContent" name="sugContent" required="required" placeholder="내용을 입력하세요"></textarea>
				      		<script>
							    $(document).ready(function() {
							    	var curtime = "";
							        $('#sugContent').summernote({
							        	 height: 500,               
							        	 minHeight: null,           
							        	 maxHeight: null,  
							        	 callbacks: {
