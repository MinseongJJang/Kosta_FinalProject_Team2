         ...
         <div style="margin-top: 100px; text-align: center;" align="center">
            ...
            <br>
                  ...
                  <div class="col-sm-1"></div>
                     ...
                     <div class="col-sm-7" id="deleteReplyDiv_${status.index}">
...
$(document).ready(function(){
   ...
   $(".replyDeleteBtn"+$(this).val()).click(function(){
      var deReply=$(this).val();
      if(confirm("삭제하시겠습니까?")==false){
         return false;
      }else{
    ...
    function qnaReplyRefresh(data){
         var info="";
         info+="<div class='col-sm-1'></div>";
         info+="<div class='col-sm-10'>";
         info+="<p align='left'>";
         info+="&nbsp;댓글</p></div>";
         info+="<div class='col-sm-1'></div><br><br>";
         $.each(data, function(index,listQNAReply){
         
         info+="<div class='col-sm-12'><div class='col-sm-1'></div>";
         info+="<div class='col-sm-1'>";
         info+="<p align='left'></p>";
         info+="</div>";
         info+="<div class='col-sm-7' id='deleteReplyDiv_"+index+"'>";
         info+="<form id='updateQnaReply"+index+"'>";
         info+="<div align='left' id='modifyReplyDiv_"+index+"'></div>";
         info+="<pre style='display:block;' id='content'>"+listQNAReply.acaQNAReplyList.qnaRepContent+"</pre>";
         info+="<input type='hidden' name='qnaRepNo' value='"+listQNAReply.acaQNAReplyList.qnaRepNo+"'>";
         info+="<input type='hidden' name='pageNo' value='1'>";
         info+="<input type='hidden' name='qnaNo' value='"+listQNAReply.acaQNAReplyList.acaQNAReplyVO.qnaNo+"'></form></div>";
         info+="<form id='qnaReplyDelete"+index+"'>";
         info+="<input type='hidden' name='qnaRepNo' value='"+listQNAReply.acaQNAReplyList.qnaRepNo+"'>";
         info+="<input type='hidden' name='qnaNo' value='"+listQNAReply.acaQNAReplyList.acaQNAReplyVO.qnaNo+"'>";
         info+="<input type='hidden' name='pageNo' value='1'>";
